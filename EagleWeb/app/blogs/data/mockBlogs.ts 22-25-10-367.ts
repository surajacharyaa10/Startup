...
export const mockBlogs: Blog[] = [
    {
        ...
        content:
            "Next.js has evolved to include powerful features like React Server Components...",
        image:
...
React Server Components (RSC) are a new type of component introduced by React that allows you to render components on the server. This approach helps reduce the amount of JavaScript sent to the client and enhances performance by offloading rendering to the server.
