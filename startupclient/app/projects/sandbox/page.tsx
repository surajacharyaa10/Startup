...
import { FiUsers, FiGitBranch, FiBox } from "react-icons/fi";
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-gray-300 text-lg md:text-xl max-w-3xl mx-auto">
            Early-stage projects exploring new ideas and technologies.
          </p>
        </motion.div>

        {products.length === 0 ? (
          <div className="text-center py-20">
            <p className="text-gray-400 text-lg">No sandbox projects yet.</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="p-5">
                  ...
                  <div className="flex flex-wrap gap-1 mb-4">
                    {product.techStack.slice(0, 3).map((t, i) => (
                      <span
                        key={i}
